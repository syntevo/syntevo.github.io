...
>but not of *SVN clones*. For SVN repositories, refer to [Externals (Normal Mode Only)](SVN-Integration.md#SVNIntegration-concepts-svn.externals).
>
>
...
[Updating Submodules](#Submodules-submodule-update).
...
<a id="Submodules-submodule-update"></a>
...
it has a *detached HEAD*. See [Working within Submodules](#Submodules-submodule-working) for more information on the
latter.
...
you need to
[commit](Local-Operations-on-the-Working-Tree.md#LocalOperationsontheWorkingTree-commit)
...
<a id="Submodules-submodule-working"></a>
