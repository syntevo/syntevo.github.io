...
### smartgit.branch.replaceInvalidCharsWith
...
These texts are used to draw old Mac OS, Windows or Unix line-endings in
...
This text is used when shortening a commit message to a single-line as
