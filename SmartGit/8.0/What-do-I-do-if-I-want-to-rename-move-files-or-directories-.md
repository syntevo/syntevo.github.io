...
-   **Git** In Git, you just rename or move your files/directories, and
    ...
    [Local Operations on the Working Tree](Local-Operations-on-the-Working-Tree.md#LocalOperationsontheWorkingTree-LocalOperationsontheWorkingTree-moving-files)
