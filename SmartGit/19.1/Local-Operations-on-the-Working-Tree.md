...
**View\|Show Ignored Files** is selected, ignored files will be shown.
...
To understand by which an *ignored* file is becoming ignored,
use **Local\|Reveal Ignore File**.
...
-   **Edit Commit Message** Invoke **Local\|Edit Commit Message** from
    ...
    commit. In the **Journal** view on the main window, you can edit the
    commit message of any of the local commits by selecting the commit
    and invoking **Edit Commit Message** from the commit's context menu.
-   **Squash Commits** To combine a range of local commits into a single
    commit, select the commit range in the **Journal** view on the main
    window and invoke **Squash Commits** from the context menu of the
    commit range.
-   **Reorder Commits** In the **Journal** view you can drag&drop a
